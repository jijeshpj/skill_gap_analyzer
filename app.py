...
def load_nlp_model():
    ...
    try:
        ...
        try:
            # 🚨 പരിഹാരം: pip ഉപയോഗിച്ച് ഡൗൺലോഡ് ചെയ്യുന്നു (ലിങ്ക് ഒഴിവാക്കി) 🚨
            ...
            # 🚨 spacy link കമാൻഡ് പൂർണ്ണമായും ഒഴിവാക്കുക 🚨
            
            # 3. ഇൻസ്റ്റാളേഷൻ വിജയകരമായാൽ, മോഡലിനെ വീണ്ടും ലോഡ് ചെയ്യുക
            # pip install ചെയ്ത മോഡൽ പാക്കേജ് നെയിം വഴി കണ്ടെത്തുമെന്ന് പ്രതീക്ഷിക്കുന്നു.
            nlp = spacy.load("en_core_web_sm") 
