...
# subprocess കമാൻഡ് ഉപയോഗിക്കുന്നില്ലെങ്കിൽ os, subprocess എന്നിവ നീക്കം ചെയ്യാം.
...
# 🚨 ശ്രദ്ധിക്കുക: @st.cache_resource ഒഴിവാക്കിയതാണ് അവസാനമായി നമ്മൾ തീരുമാനിച്ചത്.
# എങ്കിലും, മോഡൽ ലോഡ് ചെയ്ത ശേഷം ഇപ്പോൾ പ്രശ്നങ്ങൾ ഇല്ലാത്തതിനാൽ,
# ആപ്ലിക്കേഷൻ്റെ വേഗത കൂട്ടാൻ cache_resource തിരികെ കൊണ്ടുവരുന്നത് നല്ലതാണ്.
# Streamlit ഇപ്പോൾ മോഡൽ ഫോൾഡർ GitHub-ൽ നിന്ന് കണ്ടെത്താൻ പഠിച്ചതിനാൽ ഇത് സുരക്ഷിതമാണ്.

@st.cache_resource 
def load_nlp_model():
    """SpaCy മോഡൽ സുരക്ഷിതമായി ലോഡ് ചെയ്യുന്നു."""
    try:
        # മോഡൽ GitHub റിപ്പോസിറ്ററിയിൽ നിന്ന് നേരിട്ട് ലോഡ് ചെയ്യുന്നു
        nlp = spacy.load("en_core_web_sm") 
        return nlp
    except OSError:
        st.error("❌ SpaCy model 'en_core_web_sm' failed to load. Please ensure the model files are correctly placed in the repository.")
        return None
...
# st.set_page_config() മുമ്പേ നൽകിയിട്ടുണ്ട്, ഇനി നൽകേണ്ടതില്ല.
